    ...
    <div className="flex flex-col md:flex-row items-center w-4/5 mx-auto border-b-4 border-black py-12 gap-8">
      <div className="flex-1">
        <h1 className="text-5xl text-[#3E5C76] font-bold">
          Junior Full Stack <span>.JS</span> developer
        </h1>
        <p className="text-xl text-gray-600 mt-4">
          Hi, I'm Martin Lapsansky a computer science graduate from the Technical University of Kosice
        ...
        <div className="flex justify-center mt-8">
          <button
            ...
            className="flex flex-col items-center gap-2 bg-[#3E5C76] text-white px-5 py-3 rounded-lg hover:translate-y-4 transition-transform"
          >
            explore more
      ...
      <div className="flex-1">
        <img src="/html_finalprojimages/coding.gif" className="rounded-lg w-full h-auto" alt="Coding" />
      </div>
    </div>
  );
}
