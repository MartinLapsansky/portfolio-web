  ...
  return (
      <div className="w-4/5 mx-auto my-12 flex flex-col items-center">
        ...
        <div className="flex flex-col gap-6 items-center">
          ...
          {/* AI Support System */}
          <div className="flex flex-col items-center gap-5 border-b border-[#F0EBD8] pb-6 w-full sm:w-4/5 md:w-full lg:w-2/4 bg-[#7DA6DC] p-6 sm:p-9 rounded-3xl transition-transform transform hover:scale-95 cursor-pointer" >
          ...
          {/* MANET Project */}
          <div className="flex flex-col items-center gap-5 border-b border-[#F0EBD8] pb-6 w-full sm:w-4/5 md:w-full lg:w-2/4 bg-[#8DB5E1] p-6 sm:p-9 rounded-3xl transition-transform transform hover:scale-95 cursor-pointer">
          ...
          <div className="flex flex-col items-center gap-5 border-b border-[#F0EBD8] pb-6 w-full sm:w-4/5 md:w-full lg:w-2/4 bg-[#A3C9E7] p-6 sm:p-9 rounded-3xl transition-transform transform hover:scale-95 cursor-pointer">
            <h3 className="text-2xl font-bold text-black mb-2 text-center">Web application for shelters</h3>
            <div className="text-white px-4 sm:px-6">
              <p className="text-center font-semibold">
          ...
          <div className="flex flex-col items-center gap-5 border-b border-[#F0EBD8] pb-6 w-full sm:w-4/5 md:w-full lg:w-2/4 bg-[#6F93C1] p-6 sm:p-9 rounded-3xl transition-transform transform hover:scale-95 cursor-pointer">
            <h3 className="text-2xl font-bold text-black mb-2 text-center">Portfolio for the dentist</h3>
            <div className="text-white px-4 sm:px-6">
              <p className="text-center font-semibold">
